...
public class GaebalTalk extends JFrame  implements ActionListener,Runnable {
	    ...
	    public void actionPerformed(ActionEvent e) {
	        ...
	        if (message != null && !message.isEmpty()) {
	            for (String user : userName) {
	                ...
	                writeChatLog(client.getTitle(),message);
	            }
	        }
            ...
            while (true) {
                ...
                switch (protocol) {
                    ...
                    /*case "170": // (대기실에서) 대화방 인원정보
                        String roommUsers[] = msgs[1].split(",");
                        roommUser.setListData(roommUsers);
                        break;*/
    ...
    private void createChatLog(String roomTitle) {
        try {
            ...
            // D ����̺꿡 chat_log ���� ���� (��� ���� �ʿ� �� ����)
            File directory = new File("D:/chat_log");
            if (!directory.exists()) {
                directory.mkdir();
            }
