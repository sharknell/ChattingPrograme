...
public class GaebalTalk extends JFrame implements ActionListener, Runnable {
	...
	public GaebalTalk() throws IOException {
		...
		JLabel a = new JLabel("");
		a.setText(c.temperature + " " + c.weatherDescription);

// 날씨 상태에 따라 사진 설정
		if (c.weatherDescription.equals("Clear sky")) {
			a.setIcon(new ImageIcon("/Applications/fian/real/image/sunny.png"));
			...
			a.setIcon(new ImageIcon("/Applications/fian/real/image/mist.png"));
		} else if (c.weatherDescription.equals("Cloudy") || c.weatherDescription.equals("Overcast clouds")) {
			a.setIcon(new ImageIcon("/Applications/fian/real/image/cloudy.png"));
			...
			a.setIcon(new ImageIcon("/Applications/fian/real/image/few_clouds.png"));
		} else if (c.weatherDescription.equals("Shower rain") || c.weatherDescription.equals("Rain") ||
				c.weatherDescription.equals("Thunderstorm")) {
			a.setIcon(new ImageIcon("/Applications/fian/real/image/shower_rain.png"));
		} else if (c.weatherDescription.equals("Snow") || c.weatherDescription.equals("Sleet") ||
				c.weatherDescription.equals("Freezing rain")) {
			a.setIcon(new ImageIcon("/Applications/fian/real/image/snow.png"));
		} else {
			// 기본 이미지 설정
			a.setIcon(new ImageIcon("/Applications/fian/real/image/default.png"));
		}
		...
		panel_1.setBackground(new Color(27, 35, 255));
	...
	public void connect() { // (소켓)서버연결 요청
		try {
			...
			Socket s = new Socket("localhost", 5501); // 연결시도
