...
public class EngVerJoinScreen extends JFrame {
    ...
    public EngVerJoinScreen() {
        ...
        JLabel lblNewLabel_5 = new JLabel("Certified");
        ...
        panel_1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (!errorMessages.isEmpty()) {
                    StringBuilder errorMessage = new StringBuilder("The following items are not entered:\n");
                ...
                if (!SignUp.isValidPassword(password)) {
                    errorMessages.add("Password must contain at least one English letter, number and special character (!, @) and must be at least 8 characters long.");
                }
                if (SignUp.isDuplicateId(id)) {
                    errorMessages.add("This is a duplicate ID.");
                }
                if (SignUp.isDuplicatePhoneNumber(phoneNumber)) {
                    errorMessages.add("Duplicate phone number.");
                }
                if (!SignUp.isValidRRN(RRN)) {
                    errorMessages.add("This is not a valid ID number format.");
                }

                if (!errorMessages.isEmpty()) {
                    StringBuilder errorMessage = new StringBuilder("The following entries are incorrect:\n");                    
                    for (String error : errorMessages) {
                        errorMessage.append("- ").append(error).append("\n");
                    }
                    JOptionPane.showMessageDialog(EngVerJoinScreen.this, errorMessage.toString());
        ...
        ImageIcon imageIcon_3 = new ImageIcon("image/engEmail.png");
        ...
        ImageIcon imageIcon_4 = new ImageIcon("image/email_Certified.png");
