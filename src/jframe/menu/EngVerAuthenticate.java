...
import chatdb.phone.EngVerSENSMessage;
import chatdb.phone.SENSMessage;

public class EngVerAuthenticate extends JFrame {
    ...
    private EngVerEmailVerificationWindow emailVerificationWindow;
    private EngVerSENSMessage sensMessage;

    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    EngVerAuthenticate frame = new EngVerAuthenticate();
    ...
    public EngVerAuthenticate() {
        ...
        int mainFrameX = EngVerAuthenticate.this.getX();
        int mainFrameY = EngVerAuthenticate.this.getY();
        int mainFrameWidth = EngVerAuthenticate.this.getWidth();
        ...
        ImageIcon emailA = new ImageIcon("image/eng이메일인증.png");
        ...
        ImageIcon phoneA = new ImageIcon("image/eng휴대폰인증.png");
        ...
        emailVerificationWindow = new EngVerEmailVerificationWindow();
        sensMessage = new EngVerSENSMessage();
        ...
        complete.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (isEmailVerified || isPhoneVerified) {
                    ...
                    EngVerAuthenticate.this.dispose();
                } else {
                    // 둘 다 인증되지 않은 경우
                    JOptionPane.showMessageDialog(EngVerAuthenticate.this, "Not verified yet.");
                }
            }
        });
