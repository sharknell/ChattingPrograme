...
public class EngVerFirstSwing extends JFrame {
    ...
    public EngVerFirstSwing() {
        ...
        ImageIcon imageIcon_1 = new ImageIcon("image/engFindID.png");
        ...
        panel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
            	EngVerFindIdScreen findId = new EngVerFindIdScreen();
        ...
        ImageIcon imageIcon_2 = new ImageIcon("image/engFindPW.png");
        ...
        panel_1.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
            	EngVerFindPasswordScreen findPw = new EngVerFindPasswordScreen();
        ...
        ImageIcon imageIcon_4 = new ImageIcon("image/engLogin.png");
        ...
        ImageIcon imageIcon_5 = new ImageIcon("image/engJoin.png");
        ...
        panel_5.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                EngVerJoinScreen jo = new EngVerJoinScreen();
                jo.setVisible(true);
                EngVerFirstSwing.this.dispose();
            }
        });
