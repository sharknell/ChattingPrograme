...
public class EngVerFindPasswordScreen extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    EngVerFindPasswordScreen frame = new EngVerFindPasswordScreen();
    ...
    public EngVerFindPasswordScreen() {
    	setResizable(false);
        ...
        panel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (password != null) {
                	EngVerPasswordChangeScreen main = new EngVerPasswordChangeScreen();
            		main.setVisible(true);
            		EngVerFindPasswordScreen.this.dispose(); 
                } else {
